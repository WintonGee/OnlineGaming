  ...
  return (
    <div className="flex flex-col gap-2 lg:gap-6 w-full">
      <section>
        ...
        <div className="mt-1.5 lg:mt-3 rounded-xl lg:rounded-2xl border border-gray-300 dark:border-gray-700 overflow-hidden flex bg-white dark:bg-black">
      ...
      <section>
        ...
        <div className="mt-1.5 lg:mt-4 grid grid-cols-3 gap-1.5 lg:gap-3 w-full">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
            <button
              ...
              className={cn(
                'h-10 lg:h-auto lg:aspect-square rounded-lg lg:rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-200 dark:bg-gray-800 text-base lg:text-xl font-semibold text-black dark:text-white shadow-sm transition-colors',
      ...
      <section className="grid grid-cols-2 gap-1.5 lg:gap-3">
        <Button
          ...
          className="border border-gray-300 bg-gray-200 text-black dark:border-gray-700 dark:bg-gray-800 dark:text-white flex items-center justify-center gap-1.5 text-xs lg:text-base py-2 lg:py-3 h-9 lg:h-auto"
        >
        ...
        <Button
          ...
          disabled={!canUndo}
          className={cn(
            'border border-gray-300 bg-gray-200 text-black dark:border-gray-700 dark:bg-gray-800 dark:text-white text-xs lg:text-base py-2 lg:py-3 h-9 lg:h-auto',
            !canUndo && 'opacity-50'
          )}
        >
          Undo
