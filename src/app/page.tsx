...
import { Grid3x3, Grid2x2, Bomb, Type, HelpCircle, X, BoxSelect, Brain, Gamepad2, Search, LayoutGrid, Circle, Spade, KeyRound } from "lucide-react";
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: {
          ...
          description: "Classic code-breaking game - crack the secret 4-color code in 10 attempts",
          genre: "Puzzle",
          gamePlatform: "Web browser",
        },
      },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 flex items-center justify-center mb-4">
                  <KeyRound className="h-10 w-10 text-black dark:text-white group-hover:scale-110 transition-transform" />
                </div>
                <h2 className="text-2xl font-serif font-bold text-black dark:text-white mb-2">
                  Mastermind
                </h2>
