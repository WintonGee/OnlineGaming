...
import { Grid3x3, Grid2x2, Bomb, Type, HelpCircle, X, BoxSelect, Brain } from "lucide-react";
...
export default function Home() {
  const structuredData = {
    ...
    description:
      "Free online games without ads - Play Sudoku, 2048, Minesweeper, Wordle, Hangman, Tic Tac Toe, and Memory",
    publisher: {
      "@type": "Organization",
      name: "GamesAdFree",
      url: "https://gamesadfree.com",
